...
class GhostNet(nn.Module):
    def __init__(self, cfgs, num_classes=1000, width=1.0, dropout=0.2):
        ...
        self.conv_stem = nn.Conv3d(3, output_channel, 3, 2, 1, bias=False)
        ...
        self.conv_head = nn.Conv3d(input_channel, output_channel, 1, 1, 0, bias=True)
...
if __name__=='__main__':
    ...
    model = ghostnet(num_classes=101)
    model.eval()
    print(model)
