...
def get_video_frame(args):
    ...
    for frame in range(start_frame, end_frame-1):
        ...
        fram = cv2.resize(fram, dsize=(224, 224), interpolation=cv2.INTER_AREA)
...
def show_cam_on_image(img, mask, frame, pred5, pred_time, args):
    ...
    for i in range(0,16):
        ...
        cv2.imwrite('./grad_cam/'+str(NAME)+"cam.jpg", dst)
        print("LABEL[pred5[0]]",LABEL[pred5[0]])
